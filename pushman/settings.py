...
"""
Django settings for pushman project.
...
SECRET_KEY = 'sd($z9ah-v)*+b7jxzj51qp($0g224b#ubsuiby8984(014#lj'
...
WSGI_APPLICATION = 'pushman.wsgi.application'
...
# File 设置
FILE_UPLOAD_MAX_MEMORY_SIZE = 209715200  # InMemoryUploadedFile 文件最大值，设置为200M
...
EMAIL_SUBJECT_PREFIX = u'[Pushman] '
