...
class WeChatTemplateStatusCode(BaseStatusCode):
    """ 4010xx 用户相关错误码 """
    TEMPLATE_NOT_FOUND = StatusCodeField(401001, 'Template Not Found', description=u'模板不存在')
    RECEIVER_NOT_FOUND = StatusCodeField(401011, 'Receiver Not Found', description=u'接收者不存在')
